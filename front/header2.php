			...
			<div class="col-md-5 right">
				<ul>
					...
					if(isset($_SESSION['customer'])) {
						...
						?>
						<li><a href="index.php"><i class="fa fa-sign-in"></i> Logout</a></li>
						<li><a href="Settings.php?id=<?php echo $_SESSION['id'];?>"><i class="fal fa-users-cog"></i> Settings</a></li>
						<?php	
					}
					?>

					<li><a href="cart.php"><i class="fa fa-shopping-cart"></i>
					 <?php echo LANG_VALUE_19; ?> (<?php echo LANG_VALUE_1; ?><?php
