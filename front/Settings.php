...
?> 
                    ...
                    <?php
                    $c1=new ClientC();
                    $liste=$c1->getClient($_SESSION['id']);
                    ...
                    ?>
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="text" class="form-control" name="fname" value="<?php echo $key['prenom']?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="">Last Name *</label>
                                    <input type="text" class="form-control" name="lname" value="<?php echo $key['nom']?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for="">Mobile *</label>
                                    <input type="text" class="form-control" name="tel" value="<?php echo $key['tel']?>">  
                                </div>
